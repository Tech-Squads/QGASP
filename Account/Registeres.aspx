  ...
  <header id="heade">
    <div class="container-fluid">
     ...
     <div id="outer-layer"><br /><br />  
         ...
         <div>
             <div id="formstyle" style="text-align:center;"><h4 style="position:relative;top:10px;">Create new account</h4>
                 <div style="text-align:center; position:relative;top:1px;" >
          <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"
                    ControlToValidate="txtEmail" ErrorMessage="   Enter valid email address *" Font-Size="Small" ForeColor="Red" 
            ...
            <div class="input-icons" > 
                <i class="fa fa-key icon"> 
                 ...
                 <asp:TextBox runat="server" ID="txtPassword" TextMode="Password"  CssClass="btn btn-default" placeholder="New Password" Width="340px" Height="40px"/>
                  ...
                  <div style="text-align:center; position:relative;top:1px;">
                       <asp:Label ID="lblerrorPass" runat="server" ForeColor="Red" Text="" ></asp:Label>
                ...
                <i class="fa fa-key icon"> 
                 ...
                 <p style="position:relative;top:10px;">OR</p>
                   ...
                   <div class="input-icons" style="position:relative;top:10px;"> 
