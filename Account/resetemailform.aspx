<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resetemailform.aspx.cs" Inherits="QlityG.Account.resetemailform" %>
        ...
        <br />
         <div>
             <div id="formstyle" style="text-align:center;"><br />
                 <h4>Enetr your registered emaill </h4>
            ...
            <div class="input-icons"> 
                <i class="fa fa-envelope icon"> 
                 ...
                 <asp:TextBox runat="server" ID="txtEmail" CssClass="btn btn-default" TextMode="Email"  placeholder="Email Address" Width="340px" Height="40px" />
                  ...
                  <asp:Button runat="server" Text="Reset" CssClass="btn btn-default" Backcolor="blue"  ForeColor="white" Width="340px" Height="40px"  style="position:relative;top:5px;" OnClick="sendmail_Click" />
