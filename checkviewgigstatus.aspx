<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkviewgigstatus.aspx.cs" Inherits="QlityG.checkviewgigstatus" %>
     ...
     <div ><br /><br />  
         ...
         <br/><br/>
             ...
             <div id="formstyle" style="text-align:center;"><br />
                 <div id="formstyle2">
                    <h3 style="text-align:left">Search gig of your skills</h3>
                     <hr />
                    <br />

 <div style="float:left">
                     <asp:TextBox runat="server" ID="txtskills" CssClass="form-control" borderColor="Blue" placeholder="search your skills here .." Width="250px" />
                    <div style="position:relative;top:-34px;left:100px;">
                      <asp:Button runat="server" ID="searching" Text="Search" CssClass="btn btn-default"  BackColor="blue"   ForeColor="white" OnClick="searching_Click"   />
 </div>
                    </div><br /><br />
