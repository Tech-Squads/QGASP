<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestorViewGig.aspx.cs" Inherits="QlityG.RequestorViewGig" %>
...
<%--								<li class="dropdown">
								...
								<a href="#" class="dropdown-toggle icon-menu" data-toggle="dropdown" style="color:blue">
									...
									<span class="notification-dot" style="color:blue"></span>
								</a>
		...
		<div id="left-sidebar" class="sidebar">
			...
			<%--		<div class="dropdown" >
					...
					<div>
						...
						<div>
						<p style="font-size:medium;color:gray;">My gigs</p>
						<hr />
					</div>
