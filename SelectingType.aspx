     ...
     <div id="outer-layer"><br /><br />  
         ...
         <div>
             <div id="formstyle" style="text-align:center;"><br />
                 ...
                 <asp:Button runat="server" Text="Requestor" class="buttn"  CssClass="btn btn-default" Backcolor="gray" BorderColor="red" ForeColor="black" Width="340px" Font-Size="Large" Height="40px" OnClick="Unnamed1_Click"   /><br />             
                 <br />

                 <p>OR</p>
                  <asp:Button runat="server" Text="Gigger" CssClass="btn btn-default" Backcolor="gray" BorderColor="red" ForeColor="black" Width="340px"    Font-Size="Large" Height="40px" OnClick="Unnamed2_Click"   /><br />  <br />             
