<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestSendMail.aspx.cs" Inherits="QlityG.TestSendMail" %>
...
<body id="outer-layer">
     ...
     <div ><br /><br />  
         ...
         <br/><br/>
             ...
             <div id="formstyle" style="text-align:center;"><br />
                 <div id="formstyle2">
                    <h3 style="text-align:left">Send email</h3>
                     <hr />
                    <br />
 ...
 <div style="float:left">
                       ...
                       <h4>To</h4>
                     <asp:TextBox runat="server" ID="txtTo" CssClass="form-control" borderColor="Blue"  Width="250px" /><br />

                        <h4>Subject</h4>
                     <asp:TextBox runat="server" ID="txtSubject" CssClass="form-control" borderColor="Blue"  Width="250px" /><br />

                          <h4>Body</h4>
                     <asp:TextBox runat="server" ID="txtBody" CssClass="form-control" borderColor="Blue"  Width="250px" /><br />

                  
                      <asp:Button runat="server" ID="btnemail" Text="Email" CssClass="btn btn-default"  BackColor="blue"   ForeColor="white" OnClick="btnemail_Click"   />
    ...
    <br />
                           ...
                           <asp:Label ID="errorm" runat="server" Text=""></asp:Label>
     </div>
